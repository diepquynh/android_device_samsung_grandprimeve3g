...
#define omx_base_component_PrivateType_FIELDS \
	...
	tsem_t* deinterlace_flush_condition;  /** @param The deinterlace_flush_condition condition */ \
	...
	tsem_t* bDispBufFullSem;/**< @param disp_Buf_full_tsem the semaphore for display buffer full */\
